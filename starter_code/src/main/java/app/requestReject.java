 ...
 */
public class requestReject implements Handler {

   // URL of this page relative to http://localhost:7000/
   public static final String URL = "/requestReject.html";
   ...
   public void handle(Context context) throws Exception {
      ...
      html = html + "<head>" + "<title>Request Reject</title>\n";
      ...
      jdbc.deleteRequest(Email, LoginEmail);

      html = html + "<script>alert('Reject successful!')</script>";
